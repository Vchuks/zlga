...
import pic2 from "../../images/Group 25.png"
import pic3 from "../../images/Group 13.png"

const Team = () => {
  return (
    <div className='p-3 p-lg-5 magg'>
      <h2 className='transp'>Our Team</h2>
      <div className='row align-items-center pb-5 justify-content-between gap-5 gap-lg-0'>

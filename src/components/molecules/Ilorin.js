      ...
      <div className="col-sm-12 col-md-12 col-lg-6 my-4 my-lg-5 ">
        <div className=" ilorin-box my-5">
          <Text
            ...
            children="Waste Containment"
          />
          <Text
            className="text-il"
            children="We carryout domestic waste containment and communal waste containment."
          />
        ...
        <div className=" ilorin-box twoil my-5">
          <Text
            className="colordark fw-bold mb-1 fs-5"
            children="Waste Containerization"
          />
          <Text
            className="text-il"
            children="Transportation and treatment of evacuated waste as well as provision of containers for waste collection."
          />
        ...
        <div className=" ilorin-box threeil">
          <Text
            className="colordark fw-bold mb-1 fs-5"
            children="Dumpsite Management"
          />
          <Text
            className="text-il"
            children="We carryout site clearing, acquisition of weighing bays and road construction for accessibility."
          />

...
As a business development consultant, she has worked with several international institution to drive business growth and restructuring initiatives. "/>
        <button className='btn' onClick={()=>document.querySelector('#two').classList.remove('whocomment-trunc')
        }>Read more...</button>  
        {/* <button onClick={()=>document.querySelector('.whocomment').classList.add('whocomment-trunc')}>Read less...</button> */}
      </div>
    </div>

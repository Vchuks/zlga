...
const Start = () => {
  return (
    <div className="start p-3 p-lg-5">
      ...
      <div className="row gap-3 justify-content-between py-5">
        <div className="col-sm-12 col-md-12 col-lg-3 start-pic1 text-center px-4 px-lg-5 py-4"  data-aos="fade-up" data-aos-duration="2000">
          <div>
        ...
        <div className="col-sm-12 col-md-12 col-lg-3 start-pic2 text-center px-4 px-lg-5  py-4"  data-aos="fade-up" data-aos-duration="2000">
          <div>
 ...
 There is strength in unity." />
        ...
        <div className="col-sm-12 col-md-12 col-lg-3 start-pic3 text-center px-4 px-lg-5  py-4"  data-aos="fade-up" data-aos-duration="2000">
          <div>
        ...
        <div className="col-sm-12 col-md-12 col-lg-3 start-pic4 text-center px-4 px-lg-5  py-4"  data-aos="fade-up" data-aos-duration="2000">
          <div>
